            ...
            <div
                ...
                <div class="p-4 sm:p-7">
                    <div class="text-center">
                        <h1 class="block text-2xl font-bold text-gray-800 dark:text-white">{{__('front.resetPassword')}}</h1>
                    </div>
                    ...
                    <div class="mt-5">
                        ...
                        <form wire:submit.prevent="save">
                            @if(session('success'))
                                <div class="my-2 bg-green-500 text-sm text-white rounded-lg p-4" role="alert"
                                     tabindex="-1"
                            ...
                            <div class="grid gap-y-4">
                                ...
                                <div>
                                    <label for="password_confirmation"
                                           class="block text-sm mb-2 dark:text-white">{{__('form.confirmPassword')}}</label>
                                    <div class="relative">
