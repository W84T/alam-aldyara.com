            ...
            <div class="bg-white border border-gray-200 rounded-xl shadow-sm dark:bg-gray-800 dark:border-gray-700">
                <div class="p-4 sm:p-7">
                    <div class="text-center">
                        <h1 class="block text-2xl font-bold text-gray-800 dark:text-white">{{__('front.login')}}</h1>
                        <p class="mt-2 text-sm text-gray-600 dark:text-gray-400">
                            {{__('front.accountsignup')}}
                            <a wire:navigate
                    ...
                    <form wire:submit.prevent="save">
                        @if(session('error'))
                            <div class="my-2 bg-red-500 text-sm text-white rounded-lg p-4" role="alert" tabindex="-1"
                        ...
                        <div class="grid gap-y-4">
                            ...
                            <div>
                                <label for="email"
                                       class="block text-sm mb-2 dark:text-white">{{__('form.email')}}</label>
                                <div class="relative">
                            ...
                            <div>
                                <div class="flex justify-between items-center">
                                    <label for="password"
                                           class="block text-sm mb-2 dark:text-white">{{__('form.password')}}</label>
                                    <a wire:navigate
                                       ...
                                       href="/forgot">{{__('front.forgotpassword')}}</a>
                                </div>
                                <div class="relative">
